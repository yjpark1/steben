# Attention Model (AM) Baseline

This directory contains the implementation of the AM algorithm.
...
if __name__ == "__main__":
    # training
    args = Args(gpu_id=0, graph_type='ER', num_nodes=10, 
                testdata_dir="testdata_gaussian/synthetic_STP_dataset_test_erdos_renyi_n10_scipjack")
    am_stp_main(args)
